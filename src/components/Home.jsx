...
import img3 from "../static/model-3.jpg";

const Home = () => {
    return (
        
        <main  className="container-lg  w-screen h-screen bg-cover " style={{ backgroundImage: `url(${img3})`}} >
             <div className=" flex flex-col h-16 items-center justify-center space-y-4 ">
            <p className="text-5xl mt-[900px] text-white">Model Menu</p>
            <p className="underline underline-offset-2 text-xl text-white">Schedule a Test Driver</p>
